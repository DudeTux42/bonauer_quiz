...
pub fn add_abbreviation_questions(category: &mut Category) {
    category.add_question(Question::new(
        ...
        vec![
            ...
            "As Simple As Possible".to_string(),
        ],
        0,
    ));
    ...
    category.add_question(Question::new(
        ...
        vec![
            ...
            "central executive officer".to_string(),
        ],
        0,
    ));
    category.add_question(Question::new(
        ...
        vec![
            ...
            "frequently answered questions".to_string(),
        ],
        0,
    ));
    ...
    category.add_question(Question::new(
        ...
        vec![
            "Zip = move at high speed".to_string(),  // correct
    ...
    category.add_question(Question::new(
        "What doe DAG stand for?".to_string(),
        vec![
            "Directed Acyclic Graph".to_string(),      // correct
            "Damn Amazing Graph".to_string(),          // hard false
            "Directed Asynchronous Graph".to_string(), // hard false
            "Data Abstraction Graph".to_string(),      // hard false
        ],
        0,
    ));
